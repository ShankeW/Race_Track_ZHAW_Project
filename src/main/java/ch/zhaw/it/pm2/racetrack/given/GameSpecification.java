...
public interface GameSpecification {
     ...
     * @param carIndex The zero-based carIndex number
     * @return the {@code Optional<Direction>} containing the next move for the specified car,
     * or {@link Optional#empty} if no move is detected (terminate game)
     */
    Optional<Direction> nextCarMove(int carIndex);
