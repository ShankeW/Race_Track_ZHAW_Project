...
public interface UserInterface {
     ...
     * Without additional parameters it displays "Select one of the following options:" and "Selection: " by default.
     *
    ...
    /**
     * Displays a basic message to the user until it is acknowledged by user input.
     *
     * @param message the message to be displayed
     */
